...
#define SPECIES_CUSTOM_MEGA_START (MAX_SPECIES_INCLUDING_FORMS + 1)

#define SPECIES_MEGA_CHARIZARD_Z (SPECIES_CUSTOM_MEGA_START)

#define MAX_SPECIES_INCLUDING_CUSTOM_MEGAS (SPECIES_MEGA_CHARIZARD_Z)  // 1394
